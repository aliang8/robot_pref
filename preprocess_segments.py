...
def main():
    ...
    parser = argparse.ArgumentParser(description="Preprocess robot trajectory data and save segments")
    parser.add_argument("--data_path", type=str, default=DEFAULT_DATA_PATHS[0],
                        help="Path to the PT file containing trajectory data")
    parser.add_argument("--output_file", type=str, default="preprocessed/segments.pt",
    ...
    parser.add_argument("--minimal_data", action="store_true",
