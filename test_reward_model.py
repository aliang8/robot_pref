...
def create_reward_heatmap(model, device="cpu", output_path=None):
    ...
    plt.imshow(reward_grid, origin='lower', extent=[
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="reward_model_evaluation",
    ...
    # Load model
    model = load_reward_model(args.model_path, input_dim, 
    ...
    plot_reward_distribution(
        rewards, segment_labels=segment_labels,
