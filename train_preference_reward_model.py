...
def train_reward_model(dataset, model, optimizer, device, num_epochs=100, batch_size=32, eval_interval=5):
    ...
    for epoch in range(num_epochs):
        ...
        # Process batches
        for batch_idx, (segment1, segment2, targets) in enumerate(tqdm(data_loader, 
...
def main():
    parser = argparse.ArgumentParser(description="Train a reward model from preference data")
    ...
    model, training_losses, eval_accuracies = train_reward_model(
        dataset, model, optimizer, device, 
