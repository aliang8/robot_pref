...
def active_preference_learning(cfg, dataset_name=None):
    ...
    while total_labeled < total_queries and len(unlabeled_pairs) > 0:        
        ...
        print("=" * 80)
        print(f"Progress: {total_labeled}/{total_queries} labeled pairs ({total_labeled/total_queries*100:.1f}%)")
        ...
        batch_size = min(cfg.active_learning.total_queries_per_iteration, total_queries - total_labeled)
