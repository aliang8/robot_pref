...
for seed in "${seeds[@]}"; do
    ...
    eef_rm=$eef_rm use_dtw_augmentations=$use_dtw_augmentations dtw_k_augment=$dtw_k_augment use_wandb=$use_wandb
    data_path=$data_path target_data_path=$target_data_path seed=$seed \
    ...
    eef_rm=$eef_rm use_dtw_augmentations=$use_dtw_augmentations dtw_k_augment=$dtw_k_augment use_wandb=$use_wandb 
    data_path=$target_data_path seed=$seed \
    ) &
done
